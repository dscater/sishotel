...
<body>
    ...
    @foreach ($productos as $registro)
        @if (count($array_kardex[$registro->id]['kardex']) > 0 || $array_kardex[$registro->id]['array_saldo_anterior']['sw'])
            <br><br>
            <table border="1">
                <thead>
                    <tr>
                ...
                <tbody>
                    @if (count($array_kardex[$registro->id]['kardex']) > 0 || $array_kardex[$registro->id]['array_saldo_anterior']['sw'])
                        @if ($array_kardex[$registro->id]['array_saldo_anterior']['sw'])
                            <tr>
                                <td></td>
                                ...
                                <td></td>
                                <td class="centreado">
                                    {{ $array_kardex[$registro->id]['array_saldo_anterior']['saldo_anterior']['cantidad_saldo'] }}
                                </td>
                                <td class="centreado">{{ $registro->precio }}</td>
                                <td></td>
                                <td></td>
                                <td class="centreado">
                                    {{ number_format($array_kardex[$registro->id]['array_saldo_anterior']['saldo_anterior']['monto_saldo'], 2, '.', ',') }}
                                </td>
                            </tr>
                        @endif
                        @foreach ($array_kardex[$registro->id]['kardex'] as $value)
                            <tr>
