...
const { setTipoProducto, limpiarTipoProducto } = useTipoProductos();
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let respuesta = await axiosDelete(
                route("tipo_productos.destroy", item.id)
            );
...
<template>
    <Head title="Tipos de Productos"></Head>
                ...
                <div class="row">
                    <div class="col-12">
                        <MiTable
                            ...
                            :cols="headers"
                            :api="true"
                            :url="route('tipo_productos.paginado')"
                            :numPages="5"
