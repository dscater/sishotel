...
import { useEgresoProductos } from "@/composables/egreso_productos/useEgresoProductos";
...
const { oEgresoProducto, limpiarEgresoProducto } = useEgresoProductos();
const accion_form = ref(props.accion_formulario);
const muestra_form = ref(props.muestra_formulario);
const enviando = ref(false);
let form = useForm(oEgresoProducto.value);
watch(
    ...
    (newValue) => {
        ...
        if (muestra_form.value) {
            cargarListas();
            form = useForm(oEgresoProducto.value);
            document
...
const enviarFormulario = () => {
    ...
    let url =
        form["_method"] == "POST"
            ? route("egreso_productos.store")
            : route("egreso_productos.update", form.id);
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        ...
                        <el-input
                            type="textarea"
                            :class="{
                                'parsley-error': form.errors?.motivo,
                            }"
                            v-model="form.motivo"
                            autosize
                        ></el-input>
