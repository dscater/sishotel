...
class MonedaUpdateRequest extends FormRequest
{
    ...
    {
        return [
            "codigo" => "required|unique:monedas,codigo," . $this->moneda->id,
            "nombre" => "required|unique:monedas,nombre," . $this->moneda->id,
            "simbolo" => "required|unique:monedas,simbolo," . $this->moneda->id,
        ];
    }
