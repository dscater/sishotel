...
class KardexProductoService
{
     ...
     * @return void
     */
    public function registroIngreso(string $tipo_registro, Producto $producto, float $cantidad, float $precio, string $detalle = "", string $modulo = "", int $registro_id = 0): void
    {
        //buscar el ultimo registro y usar sus valores
        $ultimo = KardexProducto::where('producto_id', $producto->id)->where("status", 1);
        ...
        // INCREMENTAR STOCK
        $this->productoService->incrementarStock($producto, $cantidad);
    }
     ...
     * @return void
     */
    public function registroEgreso(string $tipo_registro, Producto $producto, float $cantidad, float $precio, string $detalle = "", string $modulo = "", int $registro_id = 0): void
    {
        //buscar el ultimo registro y usar sus valores
        ...
        // DECREMENTAR STOCK
        $this->productoService->decrementarStock($producto, $cantidad);
    }
     ...
     * @return void
     */
    public static function actualizaRegistrosKardex(int $kardex_id, int $producto_id): void
    {
